...
INSTRUMENTS_FILE = "E:/NonChakApps/Apps/Jenie/tradeJenie/dev/tradeJenie/nifty_instruments.csv"


TODAY_DATE = datetime.now().strftime("%Y-%m-%d")
LOG_FILE = f"E:/NonChakApps/Apps/Jenie/tradeJenie/dev/tradeJenie/log/live_trading_{TODAY_DATE}.log"
